...
Plot the histogram of the degrees of individual nodes of the tree
```{r fig1, tidy = TRUE, fig.width = 4, fig.height = 4, marginfigure = TRUE, fig.cap = "Distribution of the degree centrality of individual nodes"}
hist(cD$res)
```


Plot the histogram of the degrees of individual nodes of the graph
```{r fig2, tidy = TRUE, fig.width = 4, fig.height = 4, marginfigure = TRUE, fig.cap = "Distribution of the degree centrality of individual nodes"}
hist(cDgr$res)
```
